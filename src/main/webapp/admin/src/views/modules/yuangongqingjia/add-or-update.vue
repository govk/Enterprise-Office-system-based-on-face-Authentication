	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="请假理由" prop="qingjialiyou">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.qingjialiyou" label="请假理由" prop="qingjialiyou">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#00a9aa","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qingjialiyou"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.qingjialiyou = this.ruleForm.qingjialiyou.replace(reg,'../../../ssm4xo2n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
