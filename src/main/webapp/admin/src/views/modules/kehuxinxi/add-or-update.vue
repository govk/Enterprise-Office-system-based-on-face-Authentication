	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="主营业务" prop="zhuyingyewu">
					<el-input v-model="ruleForm.zhuyingyewu" placeholder="主营业务" clearable  :readonly="ro.zhuyingyewu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="主营业务" prop="zhuyingyewu">
					<el-input v-model="ruleForm.zhuyingyewu" placeholder="主营业务" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhuyingyewu'){
							this.ruleForm.zhuyingyewu = obj[o];
							this.ro.zhuyingyewu = true;
							continue;
						}
				}
